...
/* ---------- 钓鱼 ---------- */
const FISH = [
  { id: "carp",        name: "鲤鱼",   location: "山湖", season: ["春","夏","秋","冬"], time: "全天",          weather: "任意", difficulty: 15, sell: 30,  use: "湖鱼包、料理" },
  { id: "largemouth",  name: "大口黑鲈", location: "山湖", season: ["春","夏","秋","冬"], time: "06:00-19:00", weather: "任意", difficulty: 50, sell: 100, use: "湖鱼包" },
  { id: "rainbow",     name: "虹鳟",   location: "山湖/河流", season: ["夏"], time: "06:00-19:00", weather: "晴",  difficulty: 45, sell: 65,  use: "料理、送礼" },
  { id: "sturgeon",    name: "鲟鱼",   location: "山湖", season: ["夏","冬"], time: "06:00-19:00", weather: "任意", difficulty: 78, sell: 200, use: "湖鱼包（稀有）" },
  { id: "catfish",     name: "鲶鱼",   location: "河流", season: ["春","秋"], time: "全天", weather: "雨", difficulty: 75, sell: 200, use: "河鱼包（雨天）" },
  { id: "pike",        name: "狗鱼",   location: "河流", season: ["夏","冬"], time: "全天", weather: "任意", difficulty: 60, sell: 100, use: "河鱼包" },
  { id: "sardine",     name: "沙丁鱼", location: "海洋", season: ["春","秋","冬"], time: "06:00-19:00", weather: "任意", difficulty: 30, sell: 40,  use: "海鱼包" },
  { id: "tuna",        name: "金枪鱼", location: "海洋", season: ["夏","冬"], time: "06:00-19:00", weather: "任意", difficulty: 70, sell: 100, use: "海鱼包" },
  { id: "pufferfish",  name: "河豚",   location: "海洋", season: ["夏"], time: "12:00-16:00", weather: "晴", difficulty: 80, sell: 200, use: "稀有鱼、任务" },
  { id: "octopus",     name: "章鱼",   location: "海洋", season: ["夏"], time: "06:00-13:00", weather: "任意", difficulty: 95, sell: 150, use: "稀有鱼" },
  { id: "eel",         name: "鳗鱼",   location: "海洋", season: ["春","秋"], time: "16:00-02:00", weather: "雨", difficulty: 70, sell: 85,  use: "料理（雨天夜晚）" },
  { id: "sea-cucumber",name: "海参",   location: "海洋", season: ["秋","冬"], time: "06:00-19:00", weather: "任意", difficulty: 40, sell: 75,  use: "海鱼包、料理" },
  { id: "lobster",     name: "龙虾",   location: "蟹笼", season: ["春","夏","秋","冬"], time: "全天", weather: "任意", difficulty: 0,  sell: 120, use: "蟹笼捕获" },
  { id: "crab",        name: "螃蟹",   location: "蟹笼", season: ["春","夏","秋","冬"], time: "全天", weather: "任意", difficulty: 0,  sell: 100, use: "蟹笼捕获" },
];
