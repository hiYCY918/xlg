...
const CROPS = [
  ...
  { id: "strawberry", name: "草莓",     season: ["春"],       growth: 8,  regrow: 4, seed: 100, sell: 120, note: "复活节购买，多次收获" },
  { id: "kale",       name: "甘蓝菜",     season: ["春"],       growth: 6,  regrow: 0, seed: 70,  sell: 110, note: "收益稳定，经验多" },
  ...
  { id: "tomato",     name: "西红柿",     season: ["夏"],       growth: 11, regrow: 4, seed: 50,  sell: 60,  note: "多次收获" },
  ...
  { id: "blue-jazz",    name: "蓝爵",     season: ["春"],       growth: 7,  regrow: 0, seed: 30,  sell: 50,   note: "春季花卉、蜂蜜原料" },
  ...
  { id: "red-cabbage",  name: "红叶卷心菜",     season: ["夏"],       growth: 9,  regrow: 0, seed: 100, sell: 260, note: "第二年解锁" },
  { id: "poppy",        name: "虞美人花",       season: ["夏"],       growth: 7,  regrow: 0, seed: 100, sell: 140, note: "夏季花卉、罂粟籽油原料" },
  { id: "summer-squash", name: "金皮西葫芦",  season: ["夏"],       growth: 6,  regrow: 3, seed: 120, sell: 45,  note: "多次收获" },
...
const COLLECTIBLES = [
  ...
  { id: "daffodil",         name: "黄水仙",     season: ["春"],       location: "全图",     sell: 30,  use: "春季采集包" },
  { id: "leek",             name: "韭葱",     season: ["春"],       location: "全图",     sell: 60,  use: "春季采集包" },
  { id: "dandelion",        name: "蒲公英",   season: ["春"],       location: "全图",     sell: 40,  use: "春季采集包" },
  { id: "spring-onion",     name: "大葱",     season: ["春"],       location: "河岸南侧", sell: 8,   use: "春季采集包" },
  ...
  { id: "snow-yam",         name: "雪山药",   season: ["冬"],       location: "全图挖掘", sell: 100, use: "冬季采集包" },
  { id: "crocus",           name: "番红花",   season: ["冬"],       location: "全图",     sell: 60,  use: "冬季采集包" },
  { id: "holly",            name: "冬青树",     season: ["冬"],       location: "全图",     sell: 80,  use: "装饰、送礼（慎送）" },
...
const FISH = [
  ...
  { id: "largemouth",    name: "大嘴鲈鱼",   location: "山湖",       locCat: "山湖", season: SEASONS, time: "06:00-19:00", weather: "任意", difficulty: 50,  sell: 100,  use: "湖鱼包" },
  { id: "rainbow",       name: "虹鳟鱼",       location: "山湖/河流",  locCat: "山湖", season: ["夏"], time: "06:00-19:00", weather: "晴",   difficulty: 45,  sell: 65,   use: "料理、送礼" },
  { id: "sturgeon",      name: "鲟鱼",       location: "山湖",       locCat: "山湖", season: ["夏","冬"], time: "06:00-19:00", weather: "任意", difficulty: 78,  sell: 200,  use: "湖鱼包（稀有）" },
  { id: "bullhead",      name: "大头鱼",     location: "山湖",       locCat: "山湖", season: SEASONS, time: "全天",       weather: "任意", difficulty: 46,  sell: 75,   use: "湖鱼包" },
  { id: "chub",          name: "鲢鱼",       location: "山湖",       locCat: "山湖", season: SEASONS, time: "全天",       weather: "任意", difficulty: 35,  sell: 50,   use: "湖鱼包" },
  { id: "lingcod",       name: "蛇齿单线鱼",       location: "山湖/河流",  locCat: "山湖", season: ["冬"], time: "全天",       weather: "任意", difficulty: 85,  sell: 150,  use: "湖鱼包、河鱼包" },
  ...
  { id: "walleye",       name: "大眼鱼",   location: "河流",       locCat: "河流", season: ["秋"], time: "12:00-02:00", weather: "雨",   difficulty: 45,  sell: 105,  use: "河鱼包（雨天夜晚）" },
  ...
  { id: "shad",          name: "西鲱",   location: "河流",       locCat: "河流", season: ["春","夏","秋"], time: "09:00-02:00", weather: "雨", difficulty: 44, sell: 60, use: "河鱼包（雨天）" },
  ...
  { id: "dorado",        name: "麻哈脂鲤",       location: "河流",       locCat: "河流", season: ["夏"], time: "06:00-19:00", weather: "任意", difficulty: 78,  sell: 165,  use: "河鱼包（稀有）" },
  { id: "angler",        name: "鮟鱇鱼",     location: "河流（北）", locCat: "河流", season: ["秋"], time: "全天",       weather: "任意", difficulty: 85,  sell: 4500, use: "传说鱼（图鉴）" },
  { id: "glacierfish",   name: "冰川鱼",     location: "河流（南）", locCat: "河流", season: ["冬"], time: "全天",       weather: "任意", difficulty: 100, sell: 5000, use: "传说鱼（图鉴）" },
  /* ---- 海洋 ---- */
  { id: "anchovy",       name: "鳀鱼",     location: "海洋",       locCat: "海洋", season: ["春","秋"], time: "06:00-19:00", weather: "任意", difficulty: 20,  sell: 30,   use: "海鱼包" },
  ...
  { id: "albacore",      name: "青花鱼", location: "海洋",       locCat: "海洋", season: ["秋","冬"], time: "06:00-11:00 / 18:00-02:00", weather: "任意", difficulty: 60, sell: 75, use: "海鱼包" },
  { id: "flounder",      name: "比目鱼",     location: "海洋",       locCat: "海洋", season: ["夏","秋"], time: "06:00-19:00", weather: "任意", difficulty: 50,  sell: 100,  use: "海鱼包" },
  { id: "super-cucumber", name: "大海参",  location: "海洋",       locCat: "海洋", season: SEASONS, time: "18:00-02:00", weather: "任意", difficulty: 80,  sell: 250,  use: "海鱼包（稀有）" },
  ...
  { id: "clam",          name: "蛤",       location: "蟹笼·海洋", locCat: "蟹笼", season: SEASONS, time: "全天", weather: "任意", difficulty: 0, sell: 50,  use: "蟹笼捕获、料理" },
  { id: "oyster",        name: "牡蛎",       location: "蟹笼·海洋", locCat: "蟹笼", season: SEASONS, time: "全天", weather: "任意", difficulty: 0, sell: 40,  use: "蟹笼捕获" },
  { id: "mussel",        name: "蚌",       location: "蟹笼·海洋", locCat: "蟹笼", season: SEASONS, time: "全天", weather: "任意", difficulty: 0, sell: 30,  use: "蟹笼捕获、料理" },
  ...
  { id: "crayfish",      name: "小龙虾",   location: "蟹笼·淡水", locCat: "蟹笼", season: SEASONS, time: "全天", weather: "任意", difficulty: 0, sell: 75,  use: "蟹笼捕获" },
  ...
  { id: "ghostfish",     name: "鬼鱼",     location: "矿井·20/60层", locCat: "矿井", season: SEASONS, time: "全天", weather: "任意", difficulty: 50, sell: 200, use: "矿井专属" },
  { id: "ice-pip",       name: "冰柱鱼",     location: "矿井·第20层", locCat: "矿井", season: SEASONS, time: "全天", weather: "任意", difficulty: 85, sell: 500, use: "矿井专属（稀有）" },
  { id: "lava-eel",      name: "岩浆鳗鱼",   location: "矿井·第100层", locCat: "矿井", season: SEASONS, time: "全天", weather: "任意", difficulty: 90, sell: 700, use: "矿井专属（稀有）" },
  /* ---- 沙漠 ---- */
  ...
  /* ---- 其他（森林/下水道/沼泽） ---- */
  { id: "woodskip",      name: "木跃鱼",       location: "秘密森林",   locCat: "其他", season: SEASONS, time: "全天", weather: "任意", difficulty: 50, sell: 75, use: "湖鱼包" },
  { id: "mutant-carp",   name: "变种鲤鱼",   location: "下水道",     locCat: "其他", season: SEASONS, time: "全天", weather: "任意", difficulty: 80, sell: 1000, use: "传说鱼（图鉴）" },
  ...
  { id: "blue-discus",    name: "蓝铁饼鱼",   location: "姜岛",       locCat: "姜岛", season: SEASONS, time: "全天", weather: "任意", difficulty: 100, sell: 500, use: "姜岛专属（稀有）" },
...
const MINERALS = [
  ...
  { id: "gold-ore",   name: "黄金矿石",   type: "矿石", level: "矿井 80-119 层",  sell: 25,  use: "冶炼金锭" },
  ...
  { id: "opal",       name: "猫眼石",   type: "宝石", level: "全层（稀有）",    sell: 150, use: "售卖" },
  { id: "fire-opal",  name: "赤红猫眼石", type: "宝石", level: "全层（稀有）",    sell: 350, use: "售卖" },
  /* ---- 矿物补全 ---- */
  { id: "earth-crystal",   name: "地晶",       type: "矿物", level: "矿井 1-39 层",   sell: 50,   use: "制作材料" },
  { id: "frozen-tear",     name: "泪晶",   type: "矿物", level: "矿井 40-79 层",  sell: 75,   use: "送礼（塞巴斯蒂安）、制作" },
  ...
  { id: "clay",            name: "粘土",       type: "矿物", level: "全图挖掘/矿井",  sell: 20,   use: "制作材料" },
  ...
  { id: "sandstone",       name: "沙岩",       type: "矿物", level: "全层",            sell: 60,   use: "制作" },
...
const MONSTERS = [
  ...
  /* ---- 其他区域 ---- */
  { id: "wilderness-golem", name: "荒野石魔", hp: 75,  damage: 10, location: "农场（夜晚）", drops: ["纤维"], type: "傀儡" },
...
const NPCS = [
  ...
  { id: "sam",       name: "山姆",       birthday: "夏 17", loves: ["仙人掌果子", "披萨", "可乐"],   location: "山姆家",   marriageable: true,  desc: "乐队吉他手，阳光开朗的年轻人。" },
  ...
  { id: "caroline",     name: "卡洛琳",       birthday: "冬 7",  loves: ["夏季紫丁香", "鱼卷", "绿茶"],    location: "皮埃尔家",   marriageable: false, desc: "皮埃尔的妻子，喜爱花草与园艺。" },
  ...
  { id: "sandy",        name: "桑迪",         birthday: "秋 15", loves: ["番红花", "仙人掌果子"],           location: "沙漠商店",   marriageable: false, desc: "沙漠绿洲商店的老板娘，温柔友善。" },
...
/* ---------- 节日 ---------- */
const FESTIVALS = [
  { id: "egg-festival",   name: "复活节",       season: "春", day: 13, location: "广场", time: "09:00-14:00", desc: "寻找隐藏彩蛋的比赛，找到最多彩蛋获胜。" },
  { id: "flower-dance",   name: "花舞节",       season: "春", day: 24, location: "森林", time: "09:00-14:00", desc: "向心仪的村民发出舞伴邀请，共跳花之舞。" },
  { id: "luau",           name: "夏威夷宴会",     season: "夏", day: 11, location: "海滩", time: "09:00-14:00", desc: "往汤锅里加入食材，食材品质决定州长评价。" },
  { id: "moonlight",      name: "月光水母起舞",   season: "夏", day: 28, location: "海滩", time: "22:00",       desc: "与村民一起观赏迁徙的月光水母。" },
