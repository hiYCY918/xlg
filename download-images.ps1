...
$items = @{
  ...
  "tigers-eye"    = "Tigers_Eye.png"
  "star-shard"    = "Star_Shard.png"
  "petrified-slime" = "Petrified_Slime.png"
  # ---------- 战斗补全（矿井/沙漠/姜岛） ----------
  "lava-crab"     = "Lava_Crab.png"
  "cave-grub"     = "Cave_Grub.png"
  "dust-sprite"   = "Dust_Sprite.png"
  "stone-bat"     = "Stone_Bat.png"
  ...
  "gold-slime"    = "Gold_Slime.png"
  "iridium-slime" = "Iridium_Slime.png"
